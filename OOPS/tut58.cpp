...
class CWH{
    ...
    virtual void display() = 0;// = 0 implies mandatory override   . if the derived class does not contains the display function then it also becomes an abstract class
